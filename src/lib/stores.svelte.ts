...
export const serviceData: ServiceData = {
	...
	'concrete-walls': {
		...
		description: "At Luxury Floors, we recognize the importance of maintaining the integrity and visual appeal of your asphalt surfaces. Serving Vancouver, Richmond, Burnaby, Surrey, and the Lower Mainland, we specialize in expert asphalt repair solutions designed to extend the lifespan of your surfaces while enhancing their functionality and aesthetics. Whether it's minor surface damage or significant wear, our services cater to a variety of residential, commercial, and industrial needs.<br> Ideal for driveways, parking lots, roads, walkways, and industrial yards, our asphalt repair solutions address common issues such as cracks, potholes, rutting, and surface degradation. Using high-quality materials and advanced techniques, we ensure that repaired surfaces are durable, weather-resistant, and capable of handling heavy traffic and constant wear.<br> Our skilled team of professionals begins each project with a thorough surface evaluation to determine the root cause of damage. We utilize cutting-edge repair methods—such as crack sealing, pothole patching, resurfacing, and full-depth reclamation—to restore your asphalt to its original strength and smoothness. Additionally, we offer sealing services that provide enhanced protection against moisture, UV damage, and the elements, prolonging the lifespan of your asphalt surfaces.<br> At Luxury Floors, we take pride in delivering high-quality, long-lasting results that combine durability, safety, and aesthetics. Whether you're restoring a residential driveway, upgrading a commercial parking lot, or maintaining an industrial facility, our asphalt repair services are tailored to meet your specific needs. Choose Luxury Floors for reliable and innovative asphalt repair solutions, and let us help you restore the strength and beauty of your surfaces with unmatched expertise and attention to detail.",
		colorChartPoints: [
			"High-Quality Finishes",
			"Versatile Looks",
		]
